...
export const metadata: Metadata = {
  ...
  description:
    'Senior Software Engineer with 8+ years of experience in React, Node.js, and modern web technologies. Currently working at Brikl as Frontend Engineer.',
  keywords: [
    'Software Engineer',
    'Frontend Developer',
    'React Developer',
  ...
  twitter: {
    ...
    title: 'Juan Andrés Rivera - Software Engineer & Frontend Developer',
    description:
      'Senior Software Engineer with 8+ years of experience in React, Node.js, and modern web technologies.',
    images: ['/me.png'],
    creator: '@ariverak',
  },
  robots: {
